...
my $good    = new_ok('Validate::VIN' => [$goodvin] );
...
my $bad = new_ok('Validate::VIN' => [$badvin]);
...
my $short = new_ok('Validate::VIN' => [$shortvin]);
...
my $verybad = new_ok('Validate::VIN' => [$verybadvin]);
...
my $badwmi = new_ok('Validate::VIN' => [$badwmivin]);
...
my $bad10th = new_ok('Validate::VIN' => [$bad10thvin]);
